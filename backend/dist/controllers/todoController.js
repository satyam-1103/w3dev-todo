...
const TodoController = {
    createTodo: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const newTodo = yield todoModel_1.default.create({ title, description });
    ...
    getTodoById: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    updateTodo: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { title, description, dueDate, priority, completed } = req.body;
            const updatedTodo = yield todoModel_1.default.findByIdAndUpdate(req.params.id, { title, description }, { new: true });
            if (!updatedTodo) {
                return res.status(404).json({ message: "Todo not found" });
            }
